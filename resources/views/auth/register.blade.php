                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="data_nascimento" type="text" class="form-control @error('data_nascimento') is-invalid @enderror" name="cpf" value="{{ old('data_nascimento') }}" required autocomplete="data_nascimento" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="imagem" type="text" class="form-control @error('imagem') is-invalid @enderror" name="imagem" value="{{ old('imagem') }}" required autocomplete="imagem" autofocus>
