        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="divObservacao" class="form-group col-md-12" class="form-row" style="display: none; border-bottom: #cfc5c5 1px solid; padding: 0 0 20px 0; margin-bottom: 20px">
