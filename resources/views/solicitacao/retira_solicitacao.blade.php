                ...
                @for ($i = 0; $i < count($dados); $i++)
                    <tr data-id="{{ $dados[$i]->solicitacao_id }}" style="cursor: pointer">
                        ...
                        <td class="expandeOption" style="text-align: center">
                            <a type="button" class="cancelaEntrega" data-id="{{ $dados[$i]->solicitacao_id }}">
                            ...
                            <a type="button" style="margin-left: 10px" class="aprovaEntrega" data-id="{{ $dados[$i]->solicitacao_id }}">
