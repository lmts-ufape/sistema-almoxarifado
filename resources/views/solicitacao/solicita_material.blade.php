        ...
        <div class="form-row" style="padding: 0 0 0 0;">
            <div class="form-group col-md-4">
                <div class="form-group">
                    ...
                    <input type="hidden" id="nomeReceptor" name="nomeReceptor" value="{{\Illuminate\Support\Facades\Auth::user()->nome}}">
                    <input type="text" class="form-control" id="inputNomeReceptor" onkeypress="return onlyLetters(event,this);" maxlength="100" name="nomeReceptor" value="{{\Illuminate\Support\Facades\Auth::user()->nome}}" disabled="true">
                </div>
            </div>
            <div class="form-group col-md-3">
                <label for="inputRgReceptor">RG</label>
                <input type="hidden" id="rgReceptor" name="rgReceptor" value="{{\Illuminate\Support\Facades\Auth::user()->rg}}">
                <input type="number" min="1" onkeypress="return onlyNums(event,this);" oninput="return rgLength();" class="form-control" id="inputRgReceptor" name="rgReceptor" value="{{\Illuminate\Support\Facades\Auth::user()->rg}}" disabled="true">
            </div>
        </div>
